...
GrapeQLCoach.syntax( require("./syntax/CacheReverseExpression") );
GrapeQLCoach.syntax( require("./syntax/CacheFor") );
GrapeQLCoach.syntax( require("./syntax/SchemaName") );
GrapeQLCoach.syntax( require("./syntax/SchemaTable") );
