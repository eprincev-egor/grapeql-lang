...
GrapeQLCoach.syntax( require("./syntax/FromItem") );
GrapeQLCoach.syntax( require("./syntax/Join") );
GrapeQLCoach.syntax( require("./syntax/SelectFetch") );
GrapeQLCoach.syntax( require("./syntax/Select") );
GrapeQLCoach.syntax( require("./syntax/Union") );
GrapeQLCoach.syntax( require("./syntax/ValueItem") );
GrapeQLCoach.syntax( require("./syntax/ValuesRow") );
GrapeQLCoach.syntax( require("./syntax/WithQuery") );
GrapeQLCoach.syntax( require("./syntax/With") );
GrapeQLCoach.syntax( require("./syntax/Interval") );
GrapeQLCoach.syntax( require("./syntax/Exists") );
GrapeQLCoach.syntax( require("./syntax/Any") );
GrapeQLCoach.syntax( require("./syntax/In") );
